        ...
        <div class="container">
            <div class="row d-flex justify-content-center align-items-center">
                <div class="col-md-6 mx-3" style="color: black;">
                    <h1 class="titulos-bold text-center" style="font-family: 'Titulos-Bold';">¿QUE SON LOS PLANKTON?</h1>
                    <p class="fs-5">El fitoplancton está formado por pequeñas plantas y algas que viven en la capa superior iluminada por el sol de casi todos los cuerpos de agua de la Tierra.</p> 
					<p class="fs-5">Alimentados por la energía del sol, se presentan en muchas formas y tamaños. Sirven como base de la red alimentaria marina y producen oxígeno vital para la vida. Elemento diminuto pero muy importante para la salud de las personas y de nuestro planeta.</p>
                </div>
